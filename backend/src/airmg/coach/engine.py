...
def recommendations(
    ...
    if sleep_perf is not None and sleep_perf < SLEEP_DEBT_THRESHOLD:
        recs.append(
            Recommendation(
                category="sleep",
                message=(
    ...
    if (
        ...
        and strain > HIGH_STRAIN_THRESHOLD
        and recovery < BAND_YELLOW_MAX
    ):
        recs.append(
            Recommendation(
                category="strain",
